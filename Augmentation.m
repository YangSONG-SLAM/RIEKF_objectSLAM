function [X_new,P_new]=Augmentation(X,P,z,omega)
...
P_new=[P11 P11*M1' P12 P12*M2';...
    M1*P11 M1*P11*M1'+R_blk*Omega11*R_blk' M1*P12 M1*P12*M2'+R_blk*Omega12*R_blk';...
    P21 P21*M1' P22 P22*M2';...
    M2*P21 M2*P21*M1'+R_blk*Omega21*R_blk' M2*P22 M2*P22*M2'+R_blk*Omega22*R_blk'];
